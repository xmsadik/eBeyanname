...
*    TYPES row_color TYPE /itetr/tax_s_muh_ode-row_color.
    ...
    "
    TYPES mtty_ode     TYPE TABLE OF ztax_s_muh_ode.
  PRIVATE SECTION.
...
**    DATA lv_dyolu         TYPE ztax_t_beyv-dyolu.
...
*    DATA ls_ode           TYPE ztax_s_muh_ode.
*    DATA ls_gricd         TYPE ztax_s_muh_ode.
*    DATA ls_ode_smpl      TYPE mty_ode_smpl.
*    DATA lt_ode_smpl      TYPE TABLE OF mty_ode_smpl.
